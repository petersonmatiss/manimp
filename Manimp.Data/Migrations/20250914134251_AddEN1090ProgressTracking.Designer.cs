...
namespace Manimp.Data.Migrations
{
    ...
    [Migration("20250914134251_AddEN1090ProgressTracking")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Manimp.Shared.Models.AssemblyStatusHistory", b =>
                {
                    b.Property<int>("AssemblyStatusHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AssemblyStatusHistoryId"));
                    ...
                    b.HasKey("AssemblyStatusHistoryId");
                    ...
                    b.ToTable("AssemblyStatusHistories");
                });
            ...
            modelBuilder.Entity("Manimp.Shared.Models.NonComplianceReport", b =>
                {
                    b.Property<int>("NonComplianceReportId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("NonComplianceReportId"));
                    ...
                    b.Property<DateTime?>("CustomerNotifiedUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.HasKey("NonComplianceReportId");

                    b.HasIndex("AssemblyId");

                    b.HasIndex("DetectedBy");
                    ...
                    b.ToTable("NonComplianceReports");
                });

            modelBuilder.Entity("Manimp.Shared.Models.OutsourcedCoatingTracking", b =>
                {
                    b.Property<int>("OutsourcedCoatingTrackingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OutsourcedCoatingTrackingId"));
                    ...
                    b.Property<string>("CoatingSpecification")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.HasKey("OutsourcedCoatingTrackingId");
                    ...
                    b.ToTable("OutsourcedCoatingTrackings");
                });
            ...
            modelBuilder.Entity("Manimp.Shared.Models.QualityAssuranceRecord", b =>
                {
                    b.Property<int>("QualityAssuranceRecordId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("QualityAssuranceRecordId"));
                    ...
                    b.HasKey("QualityAssuranceRecordId");

                    b.HasIndex("AssemblyId");

                    b.HasIndex("ForStatus");
                    ...
                    b.ToTable("QualityAssuranceRecords");
                });
            ...
            modelBuilder.Entity("Manimp.Shared.Models.OutsourcedCoatingTracking", b =>
                {
                    b.HasOne("Manimp.Shared.Models.Assembly", "Assembly")
                        .WithMany("OutsourcedCoatingTrackings")
                        .HasForeignKey("AssemblyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Manimp.Shared.Models.QualityAssuranceRecord", b =>
                {
                    b.HasOne("Manimp.Shared.Models.Assembly", "Assembly")
                        .WithMany("QualityAssuranceRecords")
                        .HasForeignKey("AssemblyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Manimp.Shared.Models.Assembly", b =>
                {
                    ...
                    b.Navigation("NonComplianceReports");

                    b.Navigation("OutsourcedCoatingTrackings");

                    b.Navigation("QualityAssuranceRecords");
