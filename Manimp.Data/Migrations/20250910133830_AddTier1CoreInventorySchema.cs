...
{
    /// <inheritdoc />
    public partial class AddTier1CoreInventorySchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SteelGrades", x => x.SteelGradeId);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ProfileInventories",
                columns: table => new
                {
                    ProfileInventoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    PiecesOnHand = table.Column<int>(type: "int", nullable: false),
                    OriginalPieces = table.Column<int>(type: "int", nullable: false),
                    WeightPerPiece = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    ...
                    CertificateDocumentId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileInventories", x => x.ProfileInventoryId);
                    table.ForeignKey(
                        name: "FK_ProfileInventories_Documents_CertificateDocumentId",
                        column: x => x.CertificateDocumentId,
                        principalTable: "Documents",
                        principalColumn: "DocumentId",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ProfileInventories_MaterialTypes_MaterialTypeId",
                        column: x => x.MaterialTypeId,
                        principalTable: "MaterialTypes",
                        principalColumn: "MaterialTypeId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProfileInventories_ProfileTypes_ProfileTypeId",
                        column: x => x.ProfileTypeId,
                        principalTable: "ProfileTypes",
                        principalColumn: "ProfileTypeId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProfileInventories_SteelGrades_SteelGradeId",
                        column: x => x.SteelGradeId,
                        principalTable: "SteelGrades",
                        principalColumn: "SteelGradeId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProfileInventories_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileUsageLogs", x => x.ProfileUsageLogId);
                    table.ForeignKey(
                        name: "FK_ProfileUsageLogs_ProfileInventories_ProfileInventoryId",
                        column: x => x.ProfileInventoryId,
                        principalTable: "ProfileInventories",
                        principalColumn: "ProfileInventoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProfileUsageLogs_Projects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileInventories_CertificateDocumentId",
                table: "ProfileInventories",
                column: "CertificateDocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfileInventories_LotNumber",
                table: "ProfileInventories",
                column: "LotNumber");

            migrationBuilder.CreateIndex(
                name: "IX_ProfileInventories_MaterialTypeId_ProfileTypeId_SteelGradeId",
                table: "ProfileInventories",
                columns: new[] { "MaterialTypeId", "ProfileTypeId", "SteelGradeId" });

            migrationBuilder.CreateIndex(
                name: "IX_ProfileInventories_ProfileTypeId",
                table: "ProfileInventories",
                column: "ProfileTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfileInventories_SteelGradeId",
                table: "ProfileInventories",
                column: "SteelGradeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileUsageLogs_ProfileInventoryId",
                table: "ProfileUsageLogs",
                column: "ProfileInventoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileUsageLogs_UsedDate",
                table: "ProfileUsageLogs",
                column: "UsedDate");
