...
namespace Manimp.Data.Migrations
{
    ...
    [Migration("20250914064303_AddEN1090ProgressTracking")]
    partial class AddEN1090ProgressTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Manimp.Shared.Models.AssemblyProgress", b =>
                {
                    b.Property<int>("AssemblyProgressId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AssemblyProgressId"));
                    ...
                    b.Property<DateTime?>("CurrentStepCompleted")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("CurrentStepStarted")
                        .HasColumnType("datetime2");

                    b.Property<bool>("IsCoatingOutsourced")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("OutsourcedCoatingActualReturnDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("OutsourcedCoatingExpectedReturnDate")
                        .HasColumnType("datetime2");

                    b.Property<int?>("OutsourcedCoatingListId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("OutsourcedCoatingSentDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("CurrentStepStarted");

                    b.HasIndex("IsCoatingOutsourced");

                    b.HasIndex("OutsourcedCoatingListId");

                    b.HasIndex("UpdatedUtc");

                    b.ToTable("AssemblyProgresses");
                });

            modelBuilder.Entity("Manimp.Shared.Models.AssemblyProgressStepHistory", b =>
                {
                    b.Property<int>("AssemblyProgressStepHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AssemblyProgressStepHistoryId"));
                    ...
                    b.Property<DateTime?>("StepCompleted")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("StepStarted")
                        .HasColumnType("datetime2");
                    ...
                    b.HasKey("AssemblyProgressStepHistoryId");

                    b.HasIndex("AssemblyProgressId");

                    b.HasIndex("Step");

                    b.HasIndex("StepCompleted");

                    b.HasIndex("StepStarted");

                    b.ToTable("AssemblyProgressStepHistories");
                });
            ...
            modelBuilder.Entity("Manimp.Shared.Models.NonComplianceRecord", b =>
                {
                    b.Property<int>("NonComplianceRecordId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("NonComplianceRecordId"));
                    ...
                    b.Property<int>("DiscoveredAtStep")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DocumentationReferences")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("EN1090Reference")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.Property<decimal?>("TimeImpactHours")
                        .HasColumnType("decimal(8,2)");
                    ...
                    b.HasKey("NonComplianceRecordId");

                    b.HasIndex("ActualResolutionDate");

                    b.HasIndex("AssemblyId");

                    b.HasIndex("DiscoveredAtStep");
                    ...
                    b.ToTable("NonComplianceRecords");
                });

            modelBuilder.Entity("Manimp.Shared.Models.OutsourcedCoatingList", b =>
                {
                    b.Property<int>("OutsourcedCoatingListId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OutsourcedCoatingListId"));
                    ...
                    b.HasKey("OutsourcedCoatingListId");
                    ...
                    b.ToTable("OutsourcedCoatingLists");
                });
            ...
            modelBuilder.Entity("Manimp.Shared.Models.QualityCheck", b =>
                {
                    b.Property<int>("QualityCheckId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Manimp.Shared.Models.AssemblyProgress", b =>
                {
                    b.HasOne("Manimp.Shared.Models.Assembly", "Assembly")
                        .WithOne("Progress")
                        .HasForeignKey("Manimp.Shared.Models.AssemblyProgress", "AssemblyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Manimp.Shared.Models.OutsourcedCoatingList", null)
                        .WithMany("AssemblyProgresses")
                        .HasForeignKey("OutsourcedCoatingListId");
            ...
            modelBuilder.Entity("Manimp.Shared.Models.AssemblyProgressStepHistory", b =>
                {
                    b.HasOne("Manimp.Shared.Models.AssemblyProgress", "AssemblyProgress")
                        .WithMany("StepHistory")
                        .HasForeignKey("AssemblyProgressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AssemblyProgress");
                });
            ...
            modelBuilder.Entity("Manimp.Shared.Models.NonComplianceRecord", b =>
                {
                    b.HasOne("Manimp.Shared.Models.Assembly", "Assembly")
                        .WithMany("NonComplianceRecords")
                        .HasForeignKey("AssemblyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Manimp.Shared.Models.QualityCheck", "QualityCheck")
                        .WithMany("NonComplianceRecords")
            ...
            modelBuilder.Entity("Manimp.Shared.Models.Assembly", b =>
                {
                    ...
                    b.Navigation("NonComplianceRecords");
            ...
            modelBuilder.Entity("Manimp.Shared.Models.OutsourcedCoatingList", b =>
                {
                    b.Navigation("AssemblyProgresses");
                });
