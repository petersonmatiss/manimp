...
{
    /// <inheritdoc />
    public partial class AddFeatureGating : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TenantFeatureOverrideId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantFeatureOverrides", x => x.TenantFeatureOverrideId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Plans_TierLevel",
                table: "Plans",
                column: "TierLevel");

            migrationBuilder.CreateIndex(
                name: "IX_TenantFeatureOverrides_ExpiresUtc",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantSubscriptions_StartDate",
                table: "TenantSubscriptions",
                column: "StartDate");
